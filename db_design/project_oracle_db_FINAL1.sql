...
-- -----------------------------------------------------
-- Schema project_oracle_FINAL
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema project_oracle_FINAL
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `project_oracle_FINAL` DEFAULT CHARACTER SET utf8 ;
USE `project_oracle_FINAL` ;

-- -----------------------------------------------------
-- Table `project_oracle_FINAL`.`agence`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `project_oracle_FINAL`.`agence` (
...
-- -----------------------------------------------------
-- Table `project_oracle_FINAL`.`type_user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `project_oracle_FINAL`.`type_user` (
...
-- -----------------------------------------------------
-- Table `project_oracle_FINAL`.`employe`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `project_oracle_FINAL`.`employe` (
  ...
  CONSTRAINT `fk_employe_agence`
    ...
    REFERENCES `project_oracle_FINAL`.`agence` (`idagence`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_employe_type_user`
    FOREIGN KEY (`type_user_id`)
    REFERENCES `project_oracle_FINAL`.`type_user` (`idtype_user`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `project_oracle_FINAL`.`fonction`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `project_oracle_FINAL`.`fonction` (
...
-- -----------------------------------------------------
-- Table `project_oracle_FINAL`.`employe_fonction`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `project_oracle_FINAL`.`employe_fonction` (
  ...
  CONSTRAINT `fk_employe_fonction_employe_info`
    ...
    REFERENCES `project_oracle_FINAL`.`employe` (`idemploye`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_employe_fonction_fonction`
    FOREIGN KEY (`fonction_id`)
    REFERENCES `project_oracle_FINAL`.`fonction` (`idfonction`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `project_oracle_FINAL`.`client`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `project_oracle_FINAL`.`client` (
...
-- -----------------------------------------------------
-- Table `project_oracle_FINAL`.`user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `project_oracle_FINAL`.`user` (
...
-- -----------------------------------------------------
-- Table `project_oracle_FINAL`.`types_informations`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `project_oracle_FINAL`.`types_informations` (
...
-- -----------------------------------------------------
-- Table `project_oracle_FINAL`.`telephone`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `project_oracle_FINAL`.`telephone` (
  ...
  CONSTRAINT `fk_telephone_user`
    ...
    REFERENCES `project_oracle_FINAL`.`user` (`iduser`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_telephone_types_informations`
    FOREIGN KEY (`id_type_telephone`)
    REFERENCES `project_oracle_FINAL`.`types_informations` (`idtypes_informations`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `project_oracle_FINAL`.`adresse`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `project_oracle_FINAL`.`adresse` (
...
-- -----------------------------------------------------
-- Table `project_oracle_FINAL`.`email`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `project_oracle_FINAL`.`email` (
...
-- -----------------------------------------------------
-- Table `project_oracle_FINAL`.`type_compte`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `project_oracle_FINAL`.`type_compte` (
...
-- -----------------------------------------------------
-- Table `project_oracle_FINAL`.`compte`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `project_oracle_FINAL`.`compte` (
  ...
  CONSTRAINT `fk_compte_type_compte`
    ...
    REFERENCES `project_oracle_FINAL`.`type_compte` (`idtype_compte`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `project_oracle_FINAL`.`resiliation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `project_oracle_FINAL`.`resiliation` (
  ...
  CONSTRAINT `fk_resiliation_client`
    ...
    REFERENCES `project_oracle_FINAL`.`client` (`idclient`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_resiliation_compte`
    ...
    REFERENCES `project_oracle_FINAL`.`compte` (`idcompte`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `project_oracle_FINAL`.`type_carte`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `project_oracle_FINAL`.`type_carte` (
...
-- -----------------------------------------------------
-- Table `project_oracle_FINAL`.`carte`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `project_oracle_FINAL`.`carte` (
  ...
  CONSTRAINT `fk_carte_type_carte`
    ...
    REFERENCES `project_oracle_FINAL`.`type_carte` (`id_type_carte`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `project_oracle_FINAL`.`type_transcation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `project_oracle_FINAL`.`type_transcation` (
...
-- -----------------------------------------------------
-- Table `project_oracle_FINAL`.`transaction`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `project_oracle_FINAL`.`transaction` (
  ...
  INDEX `fk_transaction_compte_idx` (`compte_donneur_id` ASC, `compte_beneficiaire_id` ASC),
  CONSTRAINT `fk_transaction_type_transaction`
    FOREIGN KEY (`type_transaction_id`)
    REFERENCES `project_oracle_FINAL`.`type_transcation` (`idtype_transcation`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_transaction_compte`
    FOREIGN KEY (`compte_donneur_id` , `compte_beneficiaire_id`)
    REFERENCES `project_oracle_FINAL`.`compte` (`idcompte` , `idcompte`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `project_oracle_FINAL`.`type_credit`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `project_oracle_FINAL`.`type_credit` (
...
-- -----------------------------------------------------
-- Table `project_oracle_FINAL`.`remboursement`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `project_oracle_FINAL`.`remboursement` (
...
-- -----------------------------------------------------
-- Table `project_oracle_FINAL`.`credit`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `project_oracle_FINAL`.`credit` (
  ...
  CONSTRAINT `fk_credit_type_credit`
    ...
    REFERENCES `project_oracle_FINAL`.`type_credit` (`idtype_credit`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_credit_remboursement`
    FOREIGN KEY (`idremboursement`)
    REFERENCES `project_oracle_FINAL`.`remboursement` (`idremboursement`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `project_oracle_FINAL`.`tarif`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `project_oracle_FINAL`.`tarif` (
