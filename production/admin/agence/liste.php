...
<html lang="en">
<head>
    <title>Liste Agence | <?php echo utf8_encode($_SESSION['pseudo']);?></title>
    <meta charset="utf-8">
                            ...
                            <div id="alert-tab" class="tab-pane fade in active">
                                <div class="row">
                                    ...
                                    <div class="panel panel-blue">
                                        <div class="panel-heading">ACTIF</div>
                                            <div class="panel-body">
                                                <table class="table table-hover table-bordered">
                                                    ...
                                                    <tbody>
                                                    <?php
                                                        $requete_liste_agence="SELECT * FROM agence WHERE actif_agence=1";
                                                        ...
                                                        if($count_l_agence>0){
                                                            while($data_liste_agence=mysqli_fetch_assoc($result_liste_agence)){
                                                                    ...
                                                                    <tr class="success">
                                                                        ...
                                                                        <td><?php echo $data_liste_agence['tel_agence'];?></td>
                                                                        <td><?php echo utf8_encode($data_liste_agence['adresse_agence']);?></td>
                                                                        <td><a href="../config_agence/<?php echo sha1($data_liste_agence['idagence']);?>"><i class="icon fa fa-edit"></i><i class="fa fa-cog"></i></a></td>                                                                        
                                                                    </tr>
                                                                    <?php
                                                            }
                                                        }   
                                    ...
                                    <div class="col-lg-6">
                                    <div class="panel panel-blue">
                                        <div class="panel-heading">INACTIF</div>
                                            <div class="panel-body">
                                                <table class="table table-hover table-bordered">
                                                    <thead>
                                                    <tr>
                                                    ...
                                                    <tbody>
                                                    <?php
                                                        $requete_liste_agence="SELECT * FROM agence WHERE actif_agence=0";
                                                        $result_liste_agence=mysqli_query($connexion, $requete_liste_agence);
                                                        $count_l_agence=mysqli_num_rows($result_liste_agence);
                                                        if($count_l_agence>0){
                                                            while($data_liste_agence=mysqli_fetch_assoc($result_liste_agence)){
