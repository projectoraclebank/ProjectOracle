...
<html lang="en">
<head>
    <title>FICHE RETRAIT | <?php echo utf8_encode($_SESSION['pseudo']);?></title>
    <meta charset="utf-8">
            ...
            <div id="page-wrapper">
                ...
                <div class="page-content">
                    <div id="tab-general">
                        ...
                        <?php 
                            $requete_t="SELECT * FROM type_transcation WHERE description_type_transaction='RETRAIT'";
                                                    ...
                                                    <div class="form-body pal">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="input-icon right">
                                                                ...
                                                                <input id="inputName" type="phone"  name="montant_retrait" placeholder="montant retrait" class="form-control" required/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="input-icon right">
                                                                <i class="fa fa-file-text"></i>
                                                                <textarea id="inputName"  name="message_retrait" placeholder="message retrait" class="form-control" required></textarea>
                                                            </div>
                                                        </div>
                                                        <hr />
                                                    </div>
