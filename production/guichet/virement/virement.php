...
<html lang="en">
<head>
    <title>FICHE VIREMENT | <?php echo utf8_encode($_SESSION['pseudo']);?></title>
    <meta charset="utf-8">
            ...
            <div id="page-wrapper">
                ...
                <div class="page-content">
                    <div id="tab-general">
                        ...
                        <?php 
                            $requete_t="SELECT * FROM type_transcation WHERE description_type_transaction='VIREMENT'";
                                                    ...
                                                    <div class="form-body pal">
                                                        <div class="form-group">
                                                            <div class="input-icon right">
                                                                ...
                                                                <input id="inputName" type="text"  name="no_compte" placeholder="No Compte Donneur" class="form-control" maxlength="9" pattern="[0-9]{1,11}" required/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="input-icon right">
                                                                <i class="fa fa-credit-card"></i>
                                                                <input id="inputName" type="text"  name="no_compte_beneficiare" placeholder="No Compte Beneficiare" class="form-control" maxlength="9" pattern="[0-9]{1,11}" required/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="input-icon right">
                                                                <i class="fa fa-money"></i>
                                                                <input id="inputName" type="phone"  name="montant_retrait" placeholder="montant virement" class="form-control" required/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="input-icon right">
                                                                <i class="fa fa-file-text"></i>
                                                                <textarea id="inputName"  name="message_retrait" placeholder="message virement" class="form-control" required></textarea>
                                                            </div>
                                                        </div>
                                                        <hr />
                                                    </div>
